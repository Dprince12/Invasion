...
// ADD CLASSNAMES 
	if (_faction==5) then {
	_InfPool=	["rhs_mvd_izlom_arifleman","rhs_mvd_izlom_efreitor","rhs_mvd_izlom_grenadier_rpg","rhs_mvd_izlom_machinegunner","rhs_mvd_izlom_marksman","rhs_mvd_izlom_marksman_vss","rhs_mvd_izlom_rifleman","rhs_mvd_izlom_rifleman_asval","rhs_mvd_izlom_rifleman_LAT","rhs_mvd_izlom_sergeant"];	
	_ArmPool=	["rhs_bmd2","rhs_t80","rhs_t90a_tv"];
	_MotPool=	["RHS_BM21_MSV_01","rhs_btr80_msv","RHS_UAZ_MSV_01","rhs_uaz_dshkm_chdkz"];
	_ACHPool=	["RHS_Ka52_vvsc","RHS_Mi24P_vvs"];
	_CHPool=	["rhs_ka60_c"];
	_uavPool=	[];
	_stPool=	[];
	_shipPool=	[];
